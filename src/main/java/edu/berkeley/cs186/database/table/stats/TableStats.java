...
public class TableStats {
  ...
  public TableStats(Schema tableSchema) {
    ...
    for (DataType dataType : tableSchema.getFieldTypes()) {
  ...
  public TableStats copyWithJoin(int leftIndex,
    ...
    List<DataType> rightDataTypes = rightSchema.getFieldTypes();
    ...
    List<DataType> copyDataTypes = new ArrayList<DataType>();

    for (DataType leftDataType : this.tableSchema.getFieldTypes()) {
      copyDataTypes.add(leftDataType);
    }

    for (DataType rightDataType : rightDataTypes) {
      copyDataTypes.add(rightDataType);
    }

    Schema copySchema = new Schema(copyFields, copyDataTypes);
